...
WARNING: This link could potentially be dangerous`)) {
        ...
        t2.NULL_COLOR = { css: "#00000000", rgba: 0 }, function(e3) {
          ...
          e3.toColor = function(e4) {
            ...
            if (s3)
              return r = parseInt(s3[1]), n = parseInt(s3[2]), o = parseInt(s3[3]), a = Math.round(255 * (void 0 === s3[5] ? 1 : parseFloat(s3[5]))), h.toColor(r, n, o, a);
            if (!t3 || !i3)
...
function init(ctx, payload) {
  ...
  const terminal = new import_xterm.Terminal({ convertEol: true });
